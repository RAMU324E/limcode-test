    ...
    parameters: {
      ...
      properties: {
        ...
        taskList: {
          ...
          description: 'Required complete ordered execution task list using the same { mode, items } shape as update_task_list. Use mode="rewrite" for a new plan.'
        }
      },
