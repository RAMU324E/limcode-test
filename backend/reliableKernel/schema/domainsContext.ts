...
export const CONTEXT_DOMAIN_SCHEMAS: readonly RuntimeDomainSchema[] = [
  ...
  domain({
    ...
    indexes: ['inbox_item_id,target_conversation_id,phase,attempt_seq UNIQUE WHERE target_turn_id IS NULL', 'inbox_item_id,target_conversation_id,target_turn_id,phase,attempt_seq UNIQUE WHERE target_turn_id IS NOT NULL', 'retry_of_delivery_id', 'target_conversation_id,state,created_at'],
